...
class FavoritesVolumes extends Table
    with TableInfo<FavoritesVolumes, FavoritesVolumesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  FavoritesVolumes(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'favorites_volumes';
  @override
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  FavoritesVolumesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return FavoritesVolumesData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  FavoritesVolumes createAlias(String alias) {
    return FavoritesVolumes(attachedDatabase, alias);
  }
...
class FavoritesVolumesData extends DataClass
    implements Insertable<FavoritesVolumesData> {
  final String id;
  final int createdAt;
  const FavoritesVolumesData({required this.id, required this.createdAt});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<String>(id);
  ...
  FavoritesVolumesCompanion toCompanion(bool nullToAbsent) {
    return FavoritesVolumesCompanion(
      id: Value(id),
      createdAt: Value(createdAt),
    );
  }

  factory FavoritesVolumesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  FavoritesVolumesData copyWith({String? id, int? createdAt}) =>
      FavoritesVolumesData(
        id: id ?? this.id,
        createdAt: createdAt ?? this.createdAt,
      );
  FavoritesVolumesData copyWithCompanion(FavoritesVolumesCompanion data) {
    return FavoritesVolumesData(
      id: data.id.present ? data.id.value : this.id,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
    );
  ...
  @override
  String toString() {
    return (StringBuffer('FavoritesVolumesData(')
          ..write('id: $id, ')
          ..write('createdAt: $createdAt')
          ..write(')'))
        .toString();
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is FavoritesVolumesData &&
          other.id == this.id &&
          other.createdAt == this.createdAt);
}

class FavoritesVolumesCompanion extends UpdateCompanion<FavoritesVolumesData> {
  final Value<String> id;
  final Value<int> createdAt;
  final Value<int> rowid;
  const FavoritesVolumesCompanion({
    this.id = const Value.absent(),
    this.createdAt = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  FavoritesVolumesCompanion.insert({
    required String id,
    this.createdAt = const Value.absent(),
    this.rowid = const Value.absent(),
  }) : id = Value(id);
  static Insertable<FavoritesVolumesData> custom({
    Expression<String>? id,
    Expression<int>? createdAt,
    Expression<int>? rowid,
  }) {
  ...
  FavoritesVolumesCompanion copyWith({
    Value<String>? id,
    Value<int>? createdAt,
    Value<int>? rowid,
  }) {
  ...
  @override
  String toString() {
    return (StringBuffer('FavoritesVolumesCompanion(')
          ..write('id: $id, ')
          ..write('createdAt: $createdAt, ')
          ..write('rowid: $rowid')
          ..write(')'))
...
class DatabaseAtV4 extends GeneratedDatabase {
  ...
  late final FavoritesVolumes favoritesVolumes = FavoritesVolumes(this);
  @override
